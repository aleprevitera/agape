                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <select id="materia" required>
                            ...
                            <option value="Cardiologia e Chirurgia Cardiovascolare">Cardiologia e Chirurgia Cardiovascolare</option>
                            <option value="Chirurgia Generale">Chirurgia Generale</option>
                            <option value="Dermatologia">Dermatologia</option>
                            <option value="Ematologia">Ematologia</option>
                            <option value="Endocrinologia e Nutrizione">Endocrinologia e Nutrizione</option>
                            <option value="Gastroenterologia">Gastroenterologia</option>
                            <option value="Genetica">Genetica</option>
                            <option value="Ginecologia">Ginecologia</option>
                            <option value="Immunologia">Immunologia</option>
                            <option value="Malattie Infettive e Microbiologia">Malattie Infettive e Microbiologia</option>
                            <option value="Medicina del Lavoro">Medicina del Lavoro</option>
                            <option value="Medicina legale">Medicina legale</option>
                            <option value="Nefrologia">Nefrologia</option>
                            <option value="Neurologia e Neurochirurgia">Neurologia e Neurochirurgia</option>
                            <option value="Oftalmologia">Oftalmologia</option>
                            <option value="Oncologia">Oncologia</option>
                            <option value="Ortopedia">Ortopedia</option>
                            <option value="Otorinolaringoiatria">Otorinolaringoiatria</option>
                            <option value="Pediatria">Pediatria</option>
                            <option value="Pneumologia e Chirurgia Toracica">Pneumologia e Chirurgia Toracica</option>
                            <option value="Psichiatria">Psichiatria</option>
                            <option value="Radiologia">Radiologia</option>
                            <option value="Reumatologia">Reumatologia</option>
                            <option value="Scienze di base">Scienze di base</option>
                            <option value="Statistica, Epidemiologia e Sanità Pubblica">Statistica, Epidemiologia e Sanità Pubblica</option>
